...
ShowPlayerAPEDDialog(playerid)
{
	ShowPlayerDialog(playerid, DIALOG_ID_APEDMENU, D_S_L, ""COL_ORANGE"Меню APED", "\
...
ShowPlayerAPEDHelpDialog(playerid)
{
	static D36[] = 
			""COL_BLUE"Функция: \t"COL_BLUE"Состояние:"\
	...
	ShowPlayerDialog(playerid, DIALOG_ID_APEDHELP, D_S_TH,""COL_ORANGE"Настройки APED",d36,"Назад","Выйти");
	return true;
}
...
ShowPlayerPlayerInfoDialog(playerid)
{
	...
	format(d35, sizeof(d35), D35, hunger, endurance);
	ShowPlayerDialog(playerid, DIALOG_ID_PLAYERINFODIALOG, D_S_T,""COL_ORANGE"Информация о Вашем состоянии",d35,"Назад","Выйти");
	return true;
}
