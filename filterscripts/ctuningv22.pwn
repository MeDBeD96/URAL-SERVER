...
#define DIALOG_TYPE_PAINTJOBS 20045
#define DIALOG_TYPE_COLORS 20046
#define DIALOG_TYPE_EXHAUSTS 20047
#define DIALOG_TYPE_FBUMPS 20048
#define DIALOG_TYPE_RBUMPS 20049
#define DIALOG_TYPE_ROOFS 20050
#define DIALOG_TYPE_SPOILERS 20051
#define DIALOG_TYPE_SIDESKIRTS 20052
#define DIALOG_TYPE_BULLBARS 20053
#define DIALOG_TYPE_WHEELS 20054
#define DIALOG_TYPE_CSTEREO 20055
#define DIALOG_TYPE_HYDRAULICS 20056
#define DIALOG_TYPE_NITRO 20057
#define DIALOG_TYPE_LIGHTS 20058
#define DIALOG_TYPE_HOODS 20059
#define DIALOG_TYPE_VENTS 20060
	...
	if(dialogid == DIALOG_TYPE_PAINTJOBS)
	{
	    ...
	    if(response)
	    {
			switch(listitem)// Checking which list item was selected
			{
				...
				case 6:
        	    {
					ShowPlayerDialog(playerid, DIALOG_TYPE_MAIN, DIALOG_STYLE_LIST, "Тюнинг транспорта", "Винилы\nПокраска\nКапот\nВентиляционные отверстия\nПодфарники\nВыхлопная труба\nПередний бампер\nЗадний бампер\nКрыша\nСпойлер\nБоковые юбки\nНавесной бампер\nКолеса\nУсилители звука\nГидравлика\nЗакись азота",
					"Выбрать", "Отмена");        	    
				}
			}
		}
